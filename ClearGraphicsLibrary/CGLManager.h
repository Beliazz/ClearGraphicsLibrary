...
typedef CGL_API bool (CALLBACK*  CGLNotificationCallback)(UINT, CGLObject*, HRESULT, std::string, std::string);
...
public:	
	static inline CGLManager* GetInstance() { return m_pInstance; }
	CGLManager();
	~CGLManager();
