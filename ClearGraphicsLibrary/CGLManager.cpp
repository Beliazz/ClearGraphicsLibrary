...
cgl::CGLManager::CGLManager()
{
	...
	if (m_pInstance)
	{
		CGLLogger::Print("ERROR: only one CGLManager instance must be used...the old instance will be deleted");
		SAFE_DELETE(m_pInstance);
	}

	// set the static ptr
	CGLManager::m_pInstance = this;
