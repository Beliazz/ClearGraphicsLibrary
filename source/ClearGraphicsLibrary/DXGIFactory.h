...
namespace cgl
{
	namespace core
	{
		...
		public:
			...
			UINT GetOutputCount();
			inline PDXGIFactory GetFactory() { return m_pFactory; }
		};
		...
		public:
			...
			inline PDXGIFactory GetFactory() { return m_pAdapter->GetFactory(); }
			inline PDXGIAdapter GetAdapter() { return m_pAdapter; }
		};
